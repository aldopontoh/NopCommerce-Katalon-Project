...
WebUI.sendKeys(findTestObject('Page_nopCommerce demo store. Email wishlist to a friend/input_YourEmailAddress'), 'aldopontoh@test.com')
...
WebUI.verifyElementPresent(findTestObject('Page_nopCommerce demo store. Email wishlist to a friend/errorMessage_Only registered customers can use email a friend feature'), 
    5)
