...
WebUI.verifyElementPresent(findTestObject('Page_nopCommerce demo store. Apple MacBook Pro 13-inch/h1_Apple MacBook Pro 13-inch'), 
    5)
...
WebUI.verifyElementPresent(findTestObject('Page_nopCommerce demo store. Wishlist/a_Apple MacBook Pro 13-inch'), 5)
